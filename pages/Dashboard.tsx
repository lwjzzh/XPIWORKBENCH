...
import { Play, Box, Clock, RefreshCw, PenTool, Search, LayoutGrid, List, Pin, MessageSquare, MonitorPlay, PinOff, Zap } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="absolute top-4 right-4 z-20">
                            <button 
                                ...
                                className={`p-2 rounded-full backdrop-blur-md transition-all duration-300 ${app.isPinned ? 'bg-blue-500/20 text-blue-400 opacity-100' : 'bg-black/20 text-zinc-500 opacity-0 group-hover:opacity-100 hover:text-white hover:bg-black/40'}`}
                            >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-6 shrink-0">
                            ...
                            <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button 
                                    onClick={(e) => handlePin(e, app.id)} 
                                    className={`p-2 rounded-lg hover:bg-white/10 transition-colors ${app.isPinned ? 'text-blue-400' : 'text-zinc-500 hover:text-white'}`}
                                >
